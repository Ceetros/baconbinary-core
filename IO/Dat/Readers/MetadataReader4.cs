...
{
    public class MetadataReader4 : IMetadataReader
    {
        public bool ReadProperties(ClientBinaryReader reader, ThingType type)
        {
            while (true)
            {
                ...
                switch (flag)
                {
                    ...
                    case /*DatFlags.HasCharges*/(DatFlags)0x08: type.HasCharges = true; break;
                    case (DatFlags)0x09:
                    ...
                    case /*DatFlags.FloorChange*/(DatFlags)0x18: type.FloorChange = true; break;
